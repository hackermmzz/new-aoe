...
string ACT_BUILD_COLLAGE_NAME;
string ACT_BUILD_SIEGE_NAME;
...
string ACT_COLLAGE_CREATE_PRIEST_NAME;
string ACT_SIEGE_CREATE_STONETHROWER_NAME;
...
//    ACT_STATUS_DISABLED=root["ACT_STATUS_DISABLED"].toInt();
    ...
    ACT_BUILD_COLLAGE_NAME=root["ACT_BUILD_COLLAGE_NAME"].toString().toStdString();
    ACT_BUILD_SIEGE_NAME=root["ACT_BUILD_SIEGE_NAME"].toString().toStdString();
    ...
    ACT_COLLAGE_CREATE_PRIEST_NAME=root["ACT_COLLAGE_CREATE_PRIEST_NAME"].toString().toStdString();
    ACT_SIEGE_CREATE_STONETHROWER_NAME=root["ACT_SIEGE_CREATE_STONETHROWER_NAME"].toString().toStdString();
