...
#define BUILDING_GRANARY_ARROWTOWE_UPGRADE 4
//市场
...
#define BUILDING_MARKET_WHEEL_UPGRADE 19
#define BUILDING_MARKET_CRAFT_UPGRADE 24 // 研发工艺（铜器时代，木材加工升级版）
#define BUILDING_MARKET_PLOW_UPGRADE 25  // 研发犁（铜器时代，驯养动物升级版）
...
#define BUILDING_STOCK_UPGRADE_MISSILE_DEFENSE_INFANTRY 12
//军营
...
#define BUILDING_ARMYCAMP_CREATE_BROADSWORD 22  // 训练阔剑兵（使用未使用的编号）
#define BUILDING_ARMYCAMP_UPGRADE_BROADSWORD 23  // 升级阔剑兵科技（使用未使用的编号）

//靶场
#define BUILDING_RANGE_CREATE_BOWMAN 16
#define BUILDING_RANGE_CREATE_CHARIOT_ARCHER 21  // 训练战车弓箭手
#define BUILDING_RANGE_CREATE_COMPOSITE_BOWMAN 26  // 训练复合弓兵
#define BUILDING_RANGE_UPGRADE_COMPOSITE_BOW 27  // 升级复合弓科技

//马厩
#define BUILDING_STABLE_CREATE_SCOUT 17
#define BUILDING_STABLE_CREATE_CHARIOT 20
...
//学院
#define BUILDING_COLLAGE_CREATE_HOPLITE 51
