...
#define TIME_BUILDING_STOCK_UPGRADE_DEFENSE_INFANTRY 40 //升级步兵护甲（1级）
#define TIME_BUILDING_STOCK_UPGRADE_DEFENSE_ARCHER 40   //升级弓兵护甲（1级）

//谷仓
#define TIME_BUILD_GRANARY 30
#define TIME_BUILDING_GRANARY_RESEARCH_ARROWTOWER 10   //研发箭塔

//兵营
#define TIME_BUILD_BARRACKS 30
#define TIME_BUILDING_BARRACKS_CREATE_CLUBMAN 26
#define TIME_BUILDING_BARRACKS_CREATE_SLINGER 24
...
#define TIME_BUILDING_MARKET_UPGRADE_CUTTING 40 //升级伐木（1级）
#define TIME_BUILDING_MARKET_UPGRADE_DIGGINGSOTNE 60 //升级采集石头（1级）
#define TIME_BUILDING_MARKET_UPGRADE_FARM 60    //升级农田（1级）
