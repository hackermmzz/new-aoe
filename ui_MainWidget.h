...
public:
    ...
    ActWidget *interact11;
    ActWidget *interact12;
    ActWidget *interact6;
    ...
    void setupUi(QWidget *MainWidget)
    {
        ...
        layoutWidget->setGeometry(QRect(300, 820, 461, 151));
        gridLayout = new QGridLayout(layoutWidget);
        gridLayout->setSpacing(6);
        gridLayout->setContentsMargins(11, 11, 11, 11);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        interact1 = new ActWidget(layoutWidget);
        interact1->setObjectName(QStringLiteral("interact1"));

        gridLayout->addWidget(interact1, 0, 0, 1, 1);

        interact2 = new ActWidget(layoutWidget);
        interact2->setObjectName(QStringLiteral("interact2"));

        gridLayout->addWidget(interact2, 0, 1, 1, 1);

        interact3 = new ActWidget(layoutWidget);
        interact3->setObjectName(QStringLiteral("interact3"));

        gridLayout->addWidget(interact3, 0, 2, 1, 1);

        interact4 = new ActWidget(layoutWidget);
        interact4->setObjectName(QStringLiteral("interact4"));

        gridLayout->addWidget(interact4, 0, 3, 1, 1);

        interact5 = new ActWidget(layoutWidget);
        interact5->setObjectName(QStringLiteral("interact5"));

        gridLayout->addWidget(interact5, 0, 4, 1, 1);

        interact7 = new ActWidget(layoutWidget);
        interact7->setObjectName(QStringLiteral("interact7"));

        gridLayout->addWidget(interact7, 1, 0, 1, 1);

        interact8 = new ActWidget(layoutWidget);
        interact8->setObjectName(QStringLiteral("interact8"));

        gridLayout->addWidget(interact8, 1, 1, 1, 1);

        interact9 = new ActWidget(layoutWidget);
        interact9->setObjectName(QStringLiteral("interact9"));

        gridLayout->addWidget(interact9, 1, 2, 1, 1);

        interact10 = new ActWidget(layoutWidget);
        interact10->setObjectName(QStringLiteral("interact10"));

        gridLayout->addWidget(interact10, 1, 3, 1, 1);

        interact11 = new ActWidget(layoutWidget);
        interact11->setObjectName(QStringLiteral("interact11"));

        gridLayout->addWidget(interact11, 1, 4, 1, 1);

        interact12 = new ActWidget(layoutWidget);
        interact12->setObjectName(QStringLiteral("interact12"));

        gridLayout->addWidget(interact12, 1, 5, 1, 1);

        interact6 = new ActWidget(layoutWidget);
        interact6->setObjectName(QStringLiteral("interact6"));

        gridLayout->addWidget(interact6, 0, 5, 1, 1);
