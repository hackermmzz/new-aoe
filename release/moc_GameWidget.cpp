...
QT_MOC_LITERAL(1, 11, 8), // "sendView"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 6), // "BlockL"
QT_MOC_LITERAL(4, 28, 6), // "BlockU"
QT_MOC_LITERAL(5, 35, 3), // "num"
QT_MOC_LITERAL(6, 39, 7), // "movemap"
QT_MOC_LITERAL(7, 47, 10), // "UpdateData"
QT_MOC_LITERAL(8, 58, 12), // "setBuildMode"
QT_MOC_LITERAL(9, 71, 9) // "buildMode"

    },
    "GameWidget\0sendView\0\0BlockL\0BlockU\0"
    "num\0movemap\0UpdateData\0setBuildMode\0"
    "buildMode"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendView((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->movemap(); break;
        case 2: _t->UpdateData(); break;
        case 3: _t->setBuildMode((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (GameWidget::*_t)(int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GameWidget::sendView)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameWidget::sendView(int _t1, int _t2, int _t3)
{
